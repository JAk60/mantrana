    ...
    (lat: number, lng: number) => {
      ...
      popup([lng, lat], `
        <div style="${pointStyle}">
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px;">
            <div style="font-weight:700;font-size:12px;letter-spacing:0.06em;color:#3949AB;">
              GRID POINT
            </div>
            <button
          ...
          <div id="${locId}" style="font-size:10px;margin-top:8px;padding-top:8px;border-top:1px solid #EEE;color:#999;">
            Loading location info…
          </div>
          <div id="${seaId}" style="font-size:10px;margin-top:8px;padding-top:8px;border-top:1px solid #EEE;color:#999;">
            Loading sea state…
          </div>
        </div>
      `);
      ...
      fetch(
        ...
        .then((j) => {
          ...
          const { label, code } = classifySeaState(c.wave_height);
          el.innerHTML = `
